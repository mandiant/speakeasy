...
class Shell32(api.ApiHandler):
    ...
    def CommandLineToArgv(self, emu, argv, ctx={}):
        ...
        for i, p in enumerate(split):
            self.mem_write(
                ptrs + (i * ptrsize), strs.to_bytes(emu.get_ptr_size(), "little")
            )
    ...
    def SHGetFolderPath(self, emu, argv, ctx={}):
        ...
        if csidl == 0x1A:
            ...
            # CSIDL_RECENT
            path = (
                "C:\\Users\\{}\\\AppData\\Roaming\\Microsoft\\Windows\\Recent".format(
                    emu.get_user()["name"]
                )
            )  # noqa
        elif csidl == 9:
            # csidl_sendto
            path = "C:\\Users\\{}\\AppData\\Roaming\\Microsoft\\Windows\\SendTo".format(
                emu.get_user()["name"]
            )  # noqa
        elif csidl == 0xB:
            # CSIDL_STARTMENU
            path = "C:\\Users\\{}\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu".format(
                emu.get_user()["name"]
            )  # noqa
        elif csidl == 0x13:
            # CSIDL_NETHOOD
            ...
            # CSIDL_TEMPLATES
            path = (
                "C:\\Users\\{}\\AppData\\Roaming\\Microsoft\\Windows\\Templates".format(
                    emu.get_user()["name"]
                )
            )  # noqa
        elif csidl == 0x1B:
            ...
            # CSIDL_HISTORY
            path = "C:\\Users\\{}\\AppData\\Local\\Microsoft\\Windows\\History".format(
                emu.get_user()["name"]
            )  # noqa
        elif csidl == 0x27:
            # CSIDL_MYPICTURES
            ...
            path = "C:\\Users\\{}\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Administrative Tools".format(
                emu.get_user()["name"]
            )  # noqa
        elif csidl == 0x1D:
            # CSIDL_ALTSTARTUP
